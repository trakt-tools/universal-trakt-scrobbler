import { StarplusApi } from '@/starplus/StarplusApi';
import { ScrobbleParser } from '@common/ScrobbleParser';
import { EpisodeItem, MovieItem } from '@models/Item';

class _StarplusParser extends ScrobbleParser {
	constructor() {
		super(StarplusApi, {
			watchingUrlRegex: /\/video\/(?<id>.+)/, // https://www.starplus.com/nl-nl/video/f3f11053-d810-4b92-9c95-567bef5f215d => f3f11053-d810-4b92-9c95-567bef5f215d
		});
	}
...
export const StarplusParser = new _StarplusParser();
