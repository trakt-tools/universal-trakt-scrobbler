...
export const HistoryListItemCard = ({
	...
	if (item) {
		if (watchedAt) {
			...
			watchedAtComponent = (
				<Button color="secondary" disabled={isLoading} onClick={void openMissingWatchedDateDialog}>
				...
				<Center isHorizontal={false}>
					...
					{typeof item !== 'undefined' ? (
						<>
							...
							{openCorrectionDialog && (
								<Button color="secondary" disabled={isLoading} onClick={void openCorrectionDialog}>
